// main.js: main file for solutions to the roundiv exercise
//
// It processes values from standard input then from the "in.txt" file.
// This is appended to the submitted JavaScript program and tests the roundiv function.
//
