;;; main.scm: main file for an "inc" solution
;;;
;;; This is appended to the submitted Scheme program and tests the inc function.
;;;
...
(with-input-from-file "in.txt" udge-inc-main-udge--)
