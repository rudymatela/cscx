// main.js: main file for solutions to the digit-sum exercise
//
// It processes values from standard input then from the "in.txt" file.
// This is appended to the submitted JavaScript program and tests the digit-sum function.
//
